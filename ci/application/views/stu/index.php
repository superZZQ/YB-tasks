<div class="hd">
 ...
 <div class="all">  
    <div id="nav" class="hd1">
        <ul>
            <li><a id="a1" onclick="setTab('a',1,4)" class="curr" href="javascript:scrollTo(0,0);">填写考核表</a></li>
            <li><a id="a2" onclick="setTab('a',2,4)" href="javascript:scrollTo(0,0);">查看上一次考核表</a></li>
            <li><a id="a3" onclick="setTab('a',3,4)" href="javascript:scrollTo(0,0);">查看评价</a></li>
            <li><a id="a4" onclick="setTab('a',4,4)" href="javascript:scrollTo(0,0);">查看所有考核表</a></li>
        </ul>   
    </div>
